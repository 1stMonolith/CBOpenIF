...
SingleControlModuleTypeVTable :: struct {
    ...
    ControModulesGet:      proc "system" (this: ^SingleControlModuleTypeIF, ControModules: ^rawptr) -> HResult,
    Missing40:             proc "system" (this: ^SingleControlModuleTypeIF) -> HResult,
    ControModulesPut:      proc "system" (this: ^SingleControlModuleTypeIF, ControModules: rawptr) -> HResult,

...
FactoryVTable :: struct {
    ...
    NewParameter1:                      proc "system" (this: ^FactoryIF, Name, Type, Attribute: BStr, Direction: i32, InitialValue, ReadPermission, WritePermission, Description: BStr, Parameter: ^Parameter) -> HResult,
    NewCMParameter:                     proc "system" (this: ^FactoryIF, Name, Type: BStr, cmparameter: ^rawptr) -> HResult,
    NewCMParameter1:                    proc "system" (this: ^FactoryIF, Name, Type, Attribute, InitialValue, ReadPermission, WritePermission, Description: BStr, AutoPoint: rawptr, cmparameter: ^rawptr) -> HResult,
    ...
    NewAutoPoint:                       proc "system" (this: ^FactoryIF, AutoPos: AutoPos, AutoPoint: ^rawptr) -> HResult,
    NewPoint:                           proc "system" (this: ^FactoryIF, X, Y: i64, Point: ^rawptr) -> HResult,
    NewGraphPos:                        proc "system" (this: ^FactoryIF, XPos, YPos, Rotation, XScale, YScale: i64, GraphPos: ^rawptr) -> HResult,
    NewGraphSize:                       proc "system" (this: ^FactoryIF, LowerLeft, LowerRight: rawptr, GraphSize: ^rawptr) -> HResult,
    NewGraphNode:                       proc "system" (this: ^FactoryIF, Name: BStr, X, Y: i64, GraphNode: ^GraphNode) -> HResult,

...
functionblocktype_scope_get :: proc(functionblocktype: FunctionBlockType) -> (scope: i32, ok: bool) {
    if functionblocktype == nil do return
    if !com_connected() do return
...
functionblocktype_scope_set :: proc(functionblocktype: FunctionBlockType, scope: i32) -> (ok: bool) {
    if functionblocktype == nil do return
    if !com_connected() do return

...
controlmoduletype_scope_get :: proc(controlmoduletype: ControlModuleType) -> (scope: i32, ok: bool) {
    if controlmoduletype == nil do return
    if !com_connected() do return
...
controlmoduletype_scope_set :: proc(controlmoduletype: ControlModuleType, scope: i32) -> (ok: bool) {
    if controlmoduletype == nil do return
    if !com_connected() do return

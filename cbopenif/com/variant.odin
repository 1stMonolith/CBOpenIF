...
InitVariant :: proc(variant: ^Variant)
{
    VariantInit(variant)
}

FreeVariant :: proc(variant: ^Variant)
{
...
StringToVariant :: proc(s: string) -> (variant: Variant)
{
    v: Variant
    VariantInit(&v)
...
BoolToVariant :: proc(b: bool) -> (variant: Variant)
{
    v: Variant
    VariantInit(&v)
...
ToVariantBool :: proc(b: bool) -> (variantbool: VariantBool)
{
    variantbool = VariantBoolTrue if b else VariantBoolFalse
    return
}

FromVariantBool :: proc(vb: VariantBool) -> (b: bool)
{

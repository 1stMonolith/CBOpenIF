...
access_level :: proc {
    ...
    singlecontrolmodule_access_level_get,
    singlecontrolmodule_access_level_set,
...
cmconnection_add :: proc {
    cmconnections_cmconnection_add,
    cmconnections_cmconnection_add_at_index,
}

cmconnection_by_name :: cmconnections_cmconnection_by_name

cmconnection_by_index :: cmconnections_cmconnection_by_index
...
cmconnections :: proc {
    ...
    singlecontrolmodule_cmconnections_get,
    singlecontrolmodule_cmconnections_set,
}
...
commvariable_add :: proc {
    commvariables_commvariable_add,
...
connectedapplication_add :: proc {
    connectedapplications_connectedapplication_add,
...
connectedhwlibrary_add :: proc {
    connectedhwlibraries_connectedhwlibrary_add,
...
connectedlibrary_add :: proc {
    connectedlibraries_connectedlibrary_add,
...
controlmodule_add :: controlmodules_controlmodule_add

singlecontrolmodule_add :: controlmodules_singlecontrolmodule_add
...
diagraminstance_add :: proc {
    diagraminstances_diagraminstance_add,
...
description :: proc {
    ...
    singlecontrolmodule_description_get,
    singlecontrolmodule_description_set,
...
extensibleparameter_add :: proc {
    extensibleparameters_extensibleparameter_add,
...
externalvariable_add :: proc {
    externalvariables_externalvariable_add,
...
executioninstance_add :: proc {
    executiongroup_executioninstance_add,
...
executiongroup_add :: proc {
    executionorder_executiongroup_add,
...
globalvariable_add :: proc {
    globalvariables_globalvariable_add,
...
graphpos :: proc {
    singlecontrolmodule_graphpos_get,
    singlecontrolmodule_graphpos_set,
...
inst_guid :: proc {
    singlecontrolmodule_inst_guid_get,
    singlecontrolmodule_inst_guid_set,
...
instance_graphics :: proc {
    ...
    singlecontrolmodule_instance_graphics_get,
    singlecontrolmodule_instance_graphics_set,
}
...
name :: proc {
    ...
    singlecontrolmodule_name_get,
    singlecontrolmodule_name_set,
...
parametersetting_add :: proc {
    parametersettings_parametersetting_add,
...
safety_type :: proc {
    ...
    singlecontrolmodule_safety_type_get,
    singlecontrolmodule_safety_type_set,
...
sfcelement_remove :: sfcelements_sfcelement_remove_by_index
...
task_connection :: proc {
    ...
    singlecontrolmodule_task_connection_get,
    singlecontrolmodule_task_connection_set,
...
type_guid :: proc {
    ...
    singlecontrolmodule_type_guid_get,
    singlecontrolmodule_type_guid_set,
...
vaaddressedvariable_add :: proc {
    vaaddressedprotocol_vaaddressedvariable_add,
...
vanammedvariable_add :: proc {
    vanamedprotocol_vanammedvariable_add,
...
visibility_In_graphics :: proc {
    ...
    singlecontrolmodule_visibility_in_graphics_get,
    singlecontrolmodule_visibility_in_graphics_set,

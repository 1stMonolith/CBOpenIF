...
FactoryVTable :: struct {
    ...
    DeserializeGlobalVariable:          proc "system" (this: ^FactoryIF, XMLStr: ^BStr, GlobalVariable: ^rawptr) -> HResult,
    DeserializeVariable:                proc "system" (this: ^FactoryIF, XMLStr: ^BStr, Variable: ^rawptr) -> HResult,
    ...
    NewSingleControlModuleType1:        proc "system" (this: ^FactoryIF, Name, Description, InteractionWindow: BStr, AlarmOwner: VariantBool, Guid: BStr, GraphSize: rawptr, SingleControlModuleType: ^rawptr) -> HResult,
    ...
    NewVariable:                        proc "system" (this: ^FactoryIF, Name, TypeName: BStr, variable: ^rawptr) -> HResult,
    NewVariable1:                       proc "system" (this: ^FactoryIF, Name, TypeName, Attribute, InitialValue, ReadPermission, WritePermission, Description: BStr, variable: ^rawptr) -> HResult,
    NewGlobalVariable:                  proc "system" (this: ^FactoryIF, Name, TypeName: BStr, GlobalVariable: ^rawptr) -> HResult,
    NewGlobalVariable1:                 proc "system" (this: ^FactoryIF, Name, TypeName, Attribute, InitialValue, ReadPermission, WritePermission, Description: BStr, GlobalVariable: ^rawptr) -> HResult,
    NewExternalVariable:                proc "system" (this: ^FactoryIF, Name, Type: BStr, ExternalVariable: ^rawptr) -> HResult,
    NewExternalVariable1:               proc "system" (this: ^FactoryIF, Name, Type, Attribute, ReadPermission, WritePermission, Description: BStr, ExternalVariable: ^rawptr) -> HResult,
    NewParameter:                       proc "system" (this: ^FactoryIF, Name, TypeName: BStr, Parameter: ^rawptr) -> HResult,
    NewParameter1:                      proc "system" (this: ^FactoryIF, Name, TypeName, Attribute: BStr, Direction: i32, InitialValue, ReadPermission, WritePermission, Description: BStr, Parameter: ^rawptr) -> HResult,
    ...
    NewCMConnection1:                   proc "system" (this: ^FactoryIF, Name, ActualParameter: BStr, GraphicalConnection: VariantBool, CMConnection: ^rawptr) -> HResult,
    ...
    NewSFCTransition1:                  proc "system" (this: ^FactoryIF, Name, STCode, Dest: BStr, SFCTransition: ^rawptr) -> HResult,
    ...
    NewSFCSubSequence:                  proc "system" (this: ^FactoryIF, Name: BStr, SFCSubSequence: ^rawptr) -> HResult,
    ...
    NewILComment:                       proc "system" (this: ^FactoryIF, Comment: BStr, ILRow: ^rawptr) -> HResult,

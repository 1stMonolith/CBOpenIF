...
SignalsVTable :: struct {
    ...
    Add1:      proc "system" (this: ^SignalsIF, Name, TypeName: BStr, Signal: ^Signal) -> HResult,
    Add2:      proc "system" (this: ^SignalsIF, Name, TypeName, Attribute, InitialValue, ReadPermission, WritePermission, Description: BStr, Signal: ^Signal) -> HResult,

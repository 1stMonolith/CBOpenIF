...
ControlModuleTypeVTable :: struct {
    ...
    ControModulesGet:             proc "system" (this: ^ControlModuleTypeIF, ControModules: ^rawptr) -> HResult,
    Missing46:                    proc "system" (this: ^ControlModuleTypeIF) -> HResult,
    ControModulesPut:             proc "system" (this: ^ControlModuleTypeIF, ControModules: rawptr) -> HResult,

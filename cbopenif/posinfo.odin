...
posinfo_message_type_get :: proc(posinfo: PosInfo) -> (message_type: MessageType, ok: bool) {
    if posinfo == nil do return
    if !controlbuilder_connected() do return
    ...
    return MessageType(mt), true
}

posinfo_message_type_set :: proc(posinfo: PosInfo, message_type: MessageType) -> (ok: bool) {
    if posinfo == nil do return
    if !controlbuilder_connected() do return
